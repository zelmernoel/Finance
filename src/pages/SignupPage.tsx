      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="font-semibold text-gray-900 text-base tracking-tight">Finance</span>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-7 text-center">
            ...
            <h2 className="font-semibold text-gray-900 mb-2">Registrierung erfolgreich</h2>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-7">
          <h1 className="text-lg font-semibold text-gray-900 mb-6">Konto erstellen</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 text-sm font-semibold text-white rounded transition-opacity disabled:opacity-50"
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-xs text-gray-300 select-none">oder</span>
            <div className="flex-1 border-t border-gray-100" />
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-medium text-gray-600 bg-gray-50 border border-gray-200 rounded hover:bg-gray-100 transition-colors"
          >
            <GuestIcon />
            Als Gast fortfahren
          </button>
