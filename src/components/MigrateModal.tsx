  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6">
        <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center mb-4 mx-auto">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onDiscard}
            disabled={loading}
            className="flex-1 py-2.5 text-sm border border-gray-200 rounded text-gray-700 hover:bg-gray-50 disabled:opacity-50"
          >
            Verwerfen
          </button>
        </div>
